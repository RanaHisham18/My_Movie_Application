 ...
 * Use the [NowPlayingSeeAllFragment.newInstance] factory method to
...
class NowPlayingSeeAllFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NowPlayingSeeAllFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NowPlayingSeeAllFragment().apply {
